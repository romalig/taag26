...
export default function FinancialSection() {
  const t = useTranslations("EmpTesting.Financial");
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 mb-12 md:mb-16 max-w-5xl">
           <div>
              ...
              <h2 className="text-3xl md:text-5xl font-black leading-tight tracking-tighter">
                {t("titleA")}<br /> {t("titleB")} <span className="text-[#FF270A]">€228k.</span>
              </h2>
           </div>
        </div>
             ...
             <div className="flex flex-col gap-6 mt-8 md:mt-12 pl-8 md:pl-14 shrink-0">
                ...
                <div className="flex justify-center md:justify-start gap-6 md:gap-8">
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-xs md:text-sm font-semibold text-gray-700">{t("testingCost")}</span>
                  </div>
                  <div className="flex items-center gap-2">
                     <span className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-[#FF270A]"></span>
                     <span className="text-xs md:text-sm font-semibold text-gray-700">{t("laborCost")}</span>
                  </div>
                </div>
             ...
             <div>
                 ...
                 <ul className="space-y-4 md:space-y-6">
                   <li className="flex gap-3 md:gap-4 items-start">
                     ...
                     <span className="text-gray-700 font-medium text-sm md:text-base">{t("samples")}</span>
                   </li>
                   <li className="flex gap-3 md:gap-4 items-start">
                     <span className="font-bold text-base md:text-lg text-[#111111] shrink-0 w-5 md:w-6">B.</span>
                     <span className="text-gray-700 font-medium text-sm md:text-base">{t("weeks")}</span>
                   </li>
                   <li className="flex gap-3 md:gap-4 items-start">
                     <span className="font-bold text-base md:text-lg text-[#111111] shrink-0 w-5 md:w-6">C.</span>
                     <span className="text-gray-700 font-medium text-sm md:text-base">{t("externalCost")}<br/><span className="font-bold text-[#111111]">{t("externalRate")}</span></span>
                   </li>
                   <li className="flex gap-3 md:gap-4 items-start">
                     <span className="font-bold text-base md:text-lg text-[#111111] shrink-0 w-5 md:w-6">D.</span>
                     <span className="text-gray-700 font-medium text-sm md:text-base">{t("aigorCost")}<br/><span className="font-bold text-[#111111]">{t("aigorRate")}</span></span>
                   </li>
                   <li className="flex gap-3 md:gap-4 items-start">
                     <span className="font-bold text-base md:text-lg text-[#111111] shrink-0 w-5 md:w-6">E.</span>
                     <span className="text-gray-700 font-medium text-sm md:text-base">{t("analystCost")}<br/><span className="font-bold text-[#111111]">{t("analystRate")}</span></span>
                   </li>
                 </ul>
             </div>
