  ...
  return (
    <main className="w-full bg-white min-h-screen">
      ...
      <section className="relative w-full pt-40 pb-20 md:pb-32 flex flex-col items-center justify-center overflow-hidden">
        ...
        {/* Glow de fondo ultra sutil para darle volumen al fondo blanco */}
      ...
      {/* ========================================================= */}
      {/* 2. OUR STORY (Two Columns Layout)                           */}
      {/* ========================================================= */}
      <section className="w-full pb-24 md:pb-32">
        <div className="max-w-[1000px] mx-auto px-6">
          ...
          {/* Grilla de dos columnas para el texto */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 text-[17px] md:text-lg text-gray-600 leading-relaxed font-medium">
            ...
            <div className="space-y-6">
              <p>
                After COVID, a new era began. TAAG transformed from a traditional service-based company into a technology-driven organization.
              </p>
              <p>
                Today, our focus is squarely on developing and manufacturing advanced molecular diagnostic solutions that empower both our own hubs and partner laboratories around the world.
              </p>
            </div>
      ...
      {/* ========================================================= */}
      {/* 3. MISSION & VISION (Red Accent Layout)                     */}
      {/* ========================================================= */}
      {/* Fondo celeste súper claro inspirado en la referencia */}
        ...
        <div className="max-w-[1000px] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-32">
            ...
            <div className="flex flex-col items-start">
              ...
              {/* Texto devuelto a color negro para máxima legibilidad */}
