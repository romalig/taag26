...
// Ajusta esta ruta según dónde tengas tu ModalProvider y el contexto
...
export default function LabTxA() {
  ...
  return (
    <section className="relative w-full bg-[#f5f5f7] py-24 md:py-32 flex flex-col items-center justify-center overflow-hidden border-t border-gray-200/50">
      ...
      <div className="relative z-20 bg-[#f5f5f7] w-full mt-24 md:mt-32 pt-10 flex flex-col items-center px-6">
        
        {/* ENCABEZADO (Adaptado para comunicar el acceso incluido en el servicio) */}
        <div className="text-center max-w-[800px] mx-auto mb-20">
          <span className="inline-block py-1 px-3 rounded-full bg-[#FF270A]/10 text-[#FF270A] text-[10px] font-bold tracking-widest uppercase mb-4">
            Included with our Lab Services
          </span>
