...
import { Globe, X, ChevronDown, Users, Brain, Dna, MapPin, CheckCircle2, Box, Zap, Activity } from "lucide-react";
      ...
      >
        {items.map((item, idx) => (
          <div key={idx} className="snap-start shrink-0 flex flex-col w-[260px] md:w-[280px] h-full">
            {/* Tarjeta de carrusel en gris claro */}
            <div className="relative w-full rounded-[2rem] bg-gray-50 border border-gray-200/60 overflow-hidden mb-6 flex items-center justify-center aspect-[4/5] shrink-0">
               <div className={`absolute w-32 h-32 ${item.glowClass} blur-3xl rounded-full opacity-15`}></div>
               <div className="w-16 h-16 rounded-2xl bg-white border border-gray-100 flex items-center justify-center relative z-10">
                  {item.icon}
               </div>
            </div>
...
export default function WhereWeAre() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col font-sans">
      ...
      {/* ========================================================= */}
      {/* SECCIÓN LOCAL: Selector País y Contenido (Fondo Blanco)     */}
      {/* ========================================================= */}
      <div className="bg-white relative w-full flex-grow pb-32 flex flex-col items-center">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 md:px-6 text-left mt-16 md:mt-24">
          <div className="w-full animate-in fade-in duration-500" key={`content-${selectedCountry}-${selectedLanguage}`}>
            ...
            {/* SECCIÓN DE EQUIPOS EN GRIS CLARO */}
            ...
            <div className="flex flex-col xl:flex-row gap-8 lg:gap-10 w-full items-stretch">
              ...
              {/* TAAG HUB (Tarjeta Gris Claro) */}
              {currentData.hasHub && (
                  <div className="w-full xl:w-[60%] flex flex-col bg-gray-50 border border-gray-100 rounded-[2rem] overflow-hidden">
                    
                    <div className="w-full relative h-[200px] md:h-[240px] bg-gray-200 shrink-0">
                      ...
                      <div className="pt-6 border-t border-gray-200 mt-auto">
                          ...
                          <div className="grid grid-cols-2 gap-6">
                            <div className="flex flex-col items-center text-center gap-3">
                              <img src="/face.png" alt="Contact" className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover shrink-0 ring-4 ring-white" />
              ...
              {/* PARTNERS (Tarjetas Gris Claro) */}
              <div className={`w-full flex flex-col gap-8 lg:gap-10 ${currentData.hasHub ? 'xl:w-[40%]' : 'grid grid-cols-1 md:grid-cols-2'}`}>
                
                {/* LOCAL PARTNER */}
                <div className="bg-gray-50 border border-gray-100 rounded-[2rem] p-6 lg:p-8 flex flex-col h-full flex-1">
                    ...
                    <div className="mb-6">
                      <div className="flex items-start gap-2 text-gray-600">
                        ...
                        <div className="flex flex-col">
                          <span className="text-[12px] font-semibold">Distribuidora Local S.A.</span>
                          <span className="text-[11px] font-medium leading-snug">Av. Comercial 456, {currentData.name}</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-[2rem] p-6 lg:p-8 flex flex-col h-full flex-1">
                    ...
                    <div className="mb-6">
                      <div className="flex items-start gap-2 text-gray-600">
                        <MapPin className="w-3.5 h-3.5 shrink-0 mt-0.5" />
                        <div className="flex flex-col">
                          <span className="text-[12px] font-semibold">Laboratorio Avanzado</span>
                          <span className="text-[11px] font-medium leading-snug">Ruta Científica 789, {currentData.name}</span>
                        </div>
                      </div>
                    </div>
