...
export const FEATURED_MODALS_DATA: Record<string, any> = {
  ...
  "zero-risk-emp": { 
    ...
    eleviaProducts: {
      ...
      main: [
        { title: "Elevia Salmonella", apiTitle: "Elevia 1.1 Salmonella spp.", desc: "Ultra-fast Salmonella detection in as little as 3 hours, and 7 hours, for environmental and food samples, respectively.", image: "/Sal11.png"},
        { title: "Elevia Salmonella + Listeria spp.", apiTitle: "Elevia 2.8 Salmonella spp. and Listeria spp.", desc: "Simultaneous identification of Salmonella and Listeria spp. in a single reaction, in as little as 3 hours, and 7 hours, for environmental and food samples, respectively.", image: "/Sal_EB.png" }
      ],
      upcoming: [
        { title: "Elevia Salmonella + Enterobacteria", apiTitle: "Elevia 2.9 Salmonella spp. and Enterobacteria", desc: "Simultaneous identification of Salmonella and Enterobacteria in a single reaction, in as little as 3 hours."},
  ...
  "fast-salmonella-food": { 
    ...
    eleviaProducts: {
      intro: "Elevia is our premium suite of diagnostic products based on AiGOR technology. By targeting RNA, Elevia bypasses traditional biological limits to deliver extreme sensitivity and ultra-fast results across your testing matrices.",
      main: [
        { title: "Elevia Salmonella", apiTitle: "Elevia 1.1 Salmonella spp.", desc: "Ultra-fast Salmonella detection in as little as 3 hours, and 6 hours, for environmental and food samples, respectively.", image: "/Sal11.png" },
        { title: "Elevia Salmonella + EB", apiTitle: "Elevia 2.9 Salmonella spp. and Enterobacteria", desc: "Simultaneous identification of Salmonella and Enterobacteria in a single reaction, in as little as 3 hours.", image: "/Sal_EB.png" }
      ]
    },
    advantages: [
