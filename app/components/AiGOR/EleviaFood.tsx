...
function FoodModalContent() {
  ...
  const tm = useTranslations("EmpTesting.EleviaFood.modal");
             ...
             <table className="w-full text-left border-collapse min-w-[700px]">
               <thead>
                 <tr className="border-b-2 border-[#111111]">
                   <th className="py-4 pr-4 font-bold text-[#111111] text-[10px] uppercase tracking-widest w-[30%]">{tm("colKit")}</th>
                   <th className="py-4 px-4 font-bold text-[#111111] text-[10px] uppercase tracking-widest w-[35%]">{tm("colMatrix")}</th>
                   <th className="py-4 px-4 font-bold text-[#111111] text-[10px] uppercase tracking-widest w-[15%]">{tm("colGrammage")}</th>
                   <th className="py-4 pl-4 font-bold text-[#111111] text-[10px] uppercase tracking-widest w-[20%]">{tm("colEnrichment")}</th>
                 </tr>
               </thead>
               <tbody>
                 {loading ? (
...
function FoodAdvantageVisual({ id }: { id: number }) {
  const tv = useTranslations("EmpTesting.EleviaFood");
  switch (id) {
    case 1:
      return (
    ...
    case 4:
      return (
        <div className="absolute inset-0 bg-[#0a0a0a] flex flex-col items-center justify-center overflow-hidden border border-white/5">
          ...
          <span className="text-[10px] tracking-widest text-white/50 uppercase text-center leading-tight">
            {tv("visualWarehouseLine1")}
            <br />
            {tv("visualWarehouseLine2")}
          </span>
        </div>
      );
    case 5:
    ...
    case 6:
      return (
        <div className="absolute inset-0 bg-[#0a0a0a] flex flex-col items-center justify-center overflow-hidden border border-white/5">
          ...
          <span className="text-xs tracking-widest text-white/50 uppercase">{tv("visualDays")}</span>
        </div>
      );
    case 7:
      return (
...
export default function EleviaFood() {
  const t = useTranslations("EmpTesting.EleviaFood");
