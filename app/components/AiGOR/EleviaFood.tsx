      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 mb-20 md:mb-32">
        <div className="relative w-full min-h-[700px] md:min-h-[900px] rounded-[2rem] overflow-hidden flex flex-col bg-neutral-900 border border-white/10">
          ...
          <div className="absolute inset-0 z-20 w-full flex justify-start pt-10 md:pt-12">
            ...
            <div className="w-[90%] md:w-[60%] lg:w-[61%] flex justify-end pl-6 md:pl-0 pr-4 md:pr-4 lg:pr-4">              {/* Bloque de texto con el mismo tamaño máximo que EleviaEnvironmental (max-w-[380px]) */}
