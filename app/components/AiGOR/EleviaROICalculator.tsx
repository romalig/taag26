...
export default function EleviaROICalculator() {
  ...
  // Lógica de cálculo basada en tu idea (Proporción de ahorro)
  useEffect(() => {
    ...
    // 1. Capital liberado (El valor de la producción que ya no está estancada)
    const calculatedFreedCapital = dailyValue * daysSaved;
    
    // 2. Reducción porcentual de costos de bodega (Ej: de 3 días baja a ~0.33, te ahorras ~89% de la bodega)
  ...
  return (
    // SECCIÓN CON FONDO NEGRO MENOS OSCURO (#121212)
    <section className="w-full bg-[#121212] py-24 md:py-32 flex flex-col items-center relative overflow-hidden border-t border-white/5">
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        input[type=range]::-webkit-slider-runnable-track {
            width: 100%; height: 4px; background: rgba(255, 255, 255, 0.1); border-radius: 2px; transition: background 0.3s;
        }
        input[type=range]:hover::-webkit-slider-runnable-track {
            background: rgba(255, 255, 255, 0.2);
        }
        /* Estilos para el thumb (el botón que se arrastra) - Minimalista blanco brillante */
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-12 md:mb-16">
          ...
          <p className="text-lg text-[#a1a1a6] font-medium leading-relaxed max-w-xl">
            See how much capital you can free up by switching to same-day release with Elevia.
          </p>
        </div>

        {/* TARJETA DE LA CALCULADORA (Negro puro, sin bordes, con amplio padding) */}
        <div className="w-full bg-black rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 lg:p-20 shadow-2xl">
          
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            
            {/* COLUMNA IZQUIERDA: Inputs (Sliders elegantes) */}
            <div className="lg:col-span-5 flex flex-col gap-16">
              
              {/* Input 1: Valor Diario */}
              <div className="flex flex-col gap-6 group">
                <div className="flex justify-between items-baseline">
                  <label className="text-white/80 text-sm md:text-base font-medium tracking-wide uppercase">
              ...
              <div className="flex flex-col gap-6 group">
                <div className="flex justify-between items-baseline">
                  ...
                  <span className="text-[#FF270A] font-black text-2xl md:text-3xl tracking-tight tabular-nums">
                    {currentWaitDays} <span className="text-lg font-bold text-[#FF270A]/70">Days</span>
                  </span>
                </div>
                <div className="relative py-2">
                  <input 
            ...
            {/* COLUMNA DERECHA: Resultados Minimalistas */}
            <div className="lg:col-span-7 flex flex-col lg:items-end lg:text-right">
              ...
              <div className="mb-16 lg:mb-20 w-full">
                 <span className="text-xs md:text-sm font-bold tracking-[0.2em] text-white/40 uppercase mb-4 block">
                 ...
                 <p className="text-white/60 text-sm md:text-base font-medium max-w-md lg:ml-auto leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-8 w-full">
                ...
                {/* Secundario 1: Reducción de Costos de Bodega (Reemplaza al ahorro anual) */}
                <div className="flex flex-col lg:items-end">
                   <span className="flex items-center lg:justify-end gap-2 text-[10px] md:text-xs font-bold tracking-[0.15em] text-emerald-500/80 uppercase mb-2">
                ...
                <div className="flex flex-col lg:items-end">
                   <span className="flex items-center lg:justify-end gap-2 text-[10px] md:text-xs font-bold tracking-[0.15em] text-white/40 uppercase mb-2">
        ...
        <div className="mt-16 lg:mt-24 flex justify-center">
           <a href="#" className="group inline-flex items-center gap-2 text-[#a1a1a6] hover:text-white transition-colors font-medium text-sm md:text-base tracking-wide">
             Request a personalized financial analysis for your facility
             <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform text-[#FF270A]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
