...
export default function BookMeetingModal() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
      ...
      {/* TARJETA DEL MODAL */}
      <div className="relative w-full max-w-5xl bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in zoom-in-95 duration-300">
        ...
        <div className="md:w-2/5 bg-[#111111] text-white p-10 md:p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="mt-12 md:mt-0 relative z-10">
            {/* CAMBIO: Cambiamos 'div' por 'a' y agregamos el href mailto */}
            <a 
              href="mailto:roberto.t@taag-genetics.com" // <--- PON AQUÍ EL EMAIL REAL
            ...
            >
               <div className="w-10 h-10 rounded-full bg-gray-600 overflow-hidden border-2 border-white/10 flex items-center justify-center group-hover:border-[#FF270A] transition-colors">
                 <span className="text-xs font-bold text-white">RT</span>
               </div>
               <div>
                 <div className="text-xs font-bold text-white group-hover:text-[#FF270A] transition-colors">
                    Denis B.
                 </div>
        ...
        <div className="md:w-3/5 p-10 md:p-12 bg-white flex flex-col justify-center">
